...
---Spells
poki = poki or {} -- Ensure that the 'poki' table exists
...
awful.Populate({
    ...
    shadowCleave = NewSpell({50581}, { damage = "magic", targeted = true }),
    ...
    corruption = NewSpell({172, 6222, 6223, 7648, 11671, 11672, 25311, 27216}, { damage = "magic", targeted = true }),
    curseOfAgony = NewSpell({980, 1014, 6217, 11711, 11712, 11713, 27218}, { damage = "magic", targeted = true }),
    ...
    deathCoil = NewSpell({6789, 17925, 17926, 27223, 47859, 47860}, { damage = "magic", targeted = true }),
    drainLife = NewSpell({689, 699, 709, 7651, 11699, 11700, 27263, 47857, 47858}, { damage = "magic", targeted = true }),
    drainMana = NewSpell({5138}, { target = true }),
    fear = NewSpell({5782, 6213, 6215}, { effect = "magic", targeted = true }),
    haunt = NewSpell({48181, 59164, 59165, 59166}, { damage = "magic", targeted = true }),
    ...
    seedOfCorruption = NewSpell({27243, 47843, 47844}, { damage = "magic", targeted = true }),
    unstableAffliction = NewSpell({30108, 30404, 30405, 47843, 47844}, { damage = "magic", targeted = true }),
    drainSoul = NewSpell({1120, 8288, 8289, 11675, 11676, 27217}, { damage = "magic", targeted = true }),
    chaosBolt = NewSpell({50796, 59172, 59173, 59174, 59175}, { damage = "magic", targeted = true }),
    conflagrate = NewSpell({17962}, { damage = "magic", targeted = true }),
    demonicImmolate = NewSpell({75445}, { damage = "magic", targeted = true }),
    hellfire = NewSpell({1949, 11683, 11684, 11685, 27213}, { damage = "magic", targeted = false }),
    immolate = NewSpell({348, 707, 1094, 2941, 11665, 11667, 11668, 25309, 27215, 47837, 47838}, { damage = "magic", targeted = true }),
    incinerate = NewSpell({29722, 32231, 47837, 47838}, { damage = "magic", targeted = true }),
    rainOfFire = NewSpell({5740, 6219, 11677, 11678, 27212, 47836, 47837}, { damage = "magic", targeted = false }),
    searingPain = NewSpell({17919, 17920, 17921, 17922, 17923, 17924, 27210, 47843, 47844, 47845}, { damage = "magic", targeted = true }),
    shadowBolt = NewSpell({686, 695, 705, 1088, 1106, 7641, 11659, 11660, 25307, 27209, 47843, 47808, 47809}, { damage = "magic", targeted = true }),
    shadowburn = NewSpell({17877, 18867, 18868, 18869, 18870, 18871, 47843, 47844, 47845, 47846, 47847}, { damage = "magic", targeted = true }),
    shadowflame = NewSpell({47897, 61290}, { damage = "magic", targeted = true }),
    shadowfury = NewSpell({30283, 30413, 30414, 47847, 47848}, { damage = "magic", targeted = true }),
    soulFire = NewSpell({6353, 17924, 27211, 47843, 47844, 47845}, { damage = "magic", targeted = true }),
}, demo, getfenv(1))
...
local curseOfDoom = awful.Spell(47867, { damage = "mgaic", target = true })
